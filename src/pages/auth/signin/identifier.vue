  ...
  <form @submit.prevent="submitForm" class="flex flex-col gap-6">
    <div class="grid gap-6">
      <div class="relative">
        ...
        <Input id="email" type="email" v-model="form.data.email" required autofocus :tabindex="1" autocomplete="email"
          placeholder=" " class="peer bg-input/30 pl-10" :class="[
            form.errors.email
    ...
    <Button type="submit" class="mt-2 flex w-full items-center justify-center cursor-pointer"
